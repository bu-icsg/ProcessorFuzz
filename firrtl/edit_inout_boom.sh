...
sed -i 's/\<auto_wfi_out_0\>/auto_wfi_out_0/g' $fname
sed -i 's/\<auto_cease_out_0\>/auto_cease_out_0/g' $fname
sed -i 's/\<auto_halt_out_0\>/auto_halt_out_0/g' $fname
sed -i 's/\<auto_hartid_in\>/constants_hartid/g' $fname
